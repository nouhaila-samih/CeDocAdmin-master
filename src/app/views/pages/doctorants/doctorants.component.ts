...
import {DocExportComponent} from '../../components/doc-export/doc-export.component';
...
export class DoctorantsComponent implements OnInit {
    ...
    exporter(){
        ...
        this.refExport = this.dialogService.open(DocExportComponent, {
            data: {

            },
            header: this.lang.exporter,
            // width: '40%'
        });
        this.refExport.onClose.subscribe((data: any) => {
            if (data) {
                // console.log(query);
                this.isLoading.isExporting = true;
                this.ds.exporterDocs(this.query, data, this.isLoading);
