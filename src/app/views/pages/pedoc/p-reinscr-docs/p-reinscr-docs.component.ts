...
@Component({
  selector: 'app-p-reinscr-docs',
  templateUrl: './p-reinscr-docs.component.html',
  styleUrls: ['./p-reinscr-docs.component.css']
})
export class PReinscrDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getReinsc(this.query, 'pedoc').subscribe(
          (res) => {
