...
@Component({
  selector: 'app-p-not-reinscr-docs',
  templateUrl: './p-not-reinscr-docs.component.html',
  styleUrls: ['./p-not-reinscr-docs.component.css']
})
export class PNotReinscrDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getNotReinsc(this.query, 'pedoc').subscribe(
          (res) => {
