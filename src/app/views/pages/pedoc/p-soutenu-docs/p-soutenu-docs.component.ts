...
@Component({
  selector: 'app-p-soutenu-docs',
  templateUrl: './p-soutenu-docs.component.html',
  styleUrls: ['./p-soutenu-docs.component.css']
})
export class PSoutenuDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getSoutenu(this.query, 'pedoc').subscribe(
          (res) => {
