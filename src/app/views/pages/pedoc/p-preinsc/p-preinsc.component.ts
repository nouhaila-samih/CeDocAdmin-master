...
import { Query, ListItem } from 'src/app/utilities/models';
...
@Component({
    selector: 'app-p-preinsc',
    templateUrl: './p-preinsc.component.html',
    styleUrls: ['./p-preinsc.component.css']
})
export class PPreinscComponent implements OnInit {
    ...
    loadSujets() {
        ...
        this.apps.getPreinsc(this.query, 'pedoc').subscribe(
            (res) => {
    ...
    confirmeAll() {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                ...
                this.apps.confirmeAllPreinsc( ).subscribe(
                    res => {
                        console.log(res);
