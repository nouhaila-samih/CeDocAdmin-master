...
@Component({
  selector: 'app-p-encours-docs',
  templateUrl: './p-encours-docs.component.html',
  styleUrls: ['./p-encours-docs.component.css']
})
export class PEncoursDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getEncours(this.query, 'pedoc').subscribe(
          (res) => {
