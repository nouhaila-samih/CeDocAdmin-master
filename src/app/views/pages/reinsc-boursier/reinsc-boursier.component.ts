...
@Component({
  selector: 'app-reinsc-boursier',
  templateUrl: './reinsc-boursier.component.html',
  styleUrls: ['./reinsc-boursier.component.css']
})
export class ReinscBoursierComponent implements OnInit {
    ...
    labos: ListItem[] = [];
    bourses: ListItem[];
    exporte_url = environment.api_url + '/administration/bourses/exporteReinscritBoursier?token=';
    ...
    loadObs() {
        this.loading = true;
        this.query.not_annee_uni = this.lss.getAnneeUniId();
        this.query.statut_id = 0;
        this.query.has_normal_bourse = true;
