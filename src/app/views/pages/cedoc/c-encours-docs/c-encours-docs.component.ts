...
@Component({
  selector: 'app-c-encours-docs',
  templateUrl: './c-encours-docs.component.html',
  styleUrls: ['./c-encours-docs.component.css']
})
export class CEncoursDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getEncours(this.query, 'cedoc').subscribe(
          (res) => {
