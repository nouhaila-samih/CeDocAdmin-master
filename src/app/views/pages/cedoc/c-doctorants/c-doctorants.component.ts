...
@Component({
  selector: 'app-c-doctorants',
  templateUrl: './c-doctorants.component.html',
  styleUrls: ['./c-doctorants.component.css']
})
export class CDoctorantsComponent implements OnInit {
    ...
    loadSujets() {
        ...
        this.apps.getDocs(this.query, 'cedoc').subscribe(
            (res) => {
