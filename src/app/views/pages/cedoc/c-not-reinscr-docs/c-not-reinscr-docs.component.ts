...
@Component({
  selector: 'app-c-not-reinscr-docs',
  templateUrl: './c-not-reinscr-docs.component.html',
  styleUrls: ['./c-not-reinscr-docs.component.css']
})
export class CNotReinscrDocsComponent implements OnInit {
  ...
  loadSujets() {
      ...
      this.apps.getNotReinsc(this.query, 'cedoc').subscribe(
          (res) => {
