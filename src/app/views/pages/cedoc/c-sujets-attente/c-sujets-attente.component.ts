...
@Component({
    selector: 'app-c-sujets-attente',
    templateUrl: './c-sujets-attente.component.html',
    styleUrls: ['./c-sujets-attente.component.css']
})
export class CSujetsAttenteComponent implements OnInit {
    ...
    confirme(confirme) {
        if (!confirme) {
            ...
            this.appService.changeStatut(this.sujet_id, this.statut, this.observation, 'cedoc').subscribe(
                (res) => {
                    console.log(res);
