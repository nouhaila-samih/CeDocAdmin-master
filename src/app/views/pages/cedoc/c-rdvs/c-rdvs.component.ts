...
@Component({
    selector: "app-c-rdvs",
    templateUrl: "./c-rdvs.component.html",
    styleUrls: ["./c-rdvs.component.css"],
})
export class CRdvsComponent implements OnInit {
    rdvs: RendezVous[];
    lang = local();
    loading = true;
    ...
    loadRdv() {
        ...
        if (!this.statutRdv) {
            this.apps.getListRendezVousCedoc(this.query).subscribe(
                (res) => {
                    console.log(res);
            ...
            this.apps.filtreRdvCedoc(this.query, this.statutRdv).subscribe(
                (res) => {
                    console.log(res);
