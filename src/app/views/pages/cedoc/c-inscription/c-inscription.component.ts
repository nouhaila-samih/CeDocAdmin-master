...
@Component({
    selector: 'app-c-inscription',
    templateUrl: './c-inscription.component.html',
    styleUrls: ['./c-inscription.component.css']
})
export class CInscriptionComponent implements OnInit {
    ...
    loadSujets() {
        ...
        this.apps.getInsc(this.query, 'cedoc').subscribe(
            (res) => {
