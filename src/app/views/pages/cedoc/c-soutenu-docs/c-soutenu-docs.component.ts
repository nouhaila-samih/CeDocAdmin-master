...
@Component({
  selector: 'app-c-soutenu-docs',
  templateUrl: './c-soutenu-docs.component.html',
  styleUrls: ['./c-soutenu-docs.component.css']
})
export class CSoutenuDocsComponent implements OnInit {
  docs: any[] = [];
  statuses: ListItem[];
  ...
  loadSujets() {
      ...
      this.apps.getSoutenu(this.query, 'cedoc').subscribe(
          (res) => {
