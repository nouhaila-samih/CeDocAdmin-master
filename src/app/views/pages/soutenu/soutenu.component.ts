...
@Component({
  selector: 'app-soutenu',
  templateUrl: './soutenu.component.html',
  styleUrls: ['./soutenu.component.css']
})
export class SoutenuComponent implements OnInit {
