...
@Component({
  selector: 'app-reinscr-docs',
  templateUrl: './reinscr-docs.component.html',
  styleUrls: ['./reinscr-docs.component.css']
})
export class ReinscrDocsComponent implements OnInit {
